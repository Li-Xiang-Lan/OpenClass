...
public class StatusLayoutManager {
    ...
    public static final class Builder {
        ...
        private int netWorkErrorRetryViewId= R.id.network_error_btn;
        private ViewStub emptyDataVs;
        private int emptyDataRetryViewId=R.id.empty_data_btn;
        private ViewStub errorVs;
        private int errorRetryViewId=R.id.error_btn;
        private int retryViewId;
        private int emptyDataIconImageId=R.id.empty_img;
        private int emptyDataTextTipId=R.id.empty_data_text;
